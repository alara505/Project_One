Feature: View Reimbursements
  Scenario: as an employee, I should be able to review my reimbursements requests so I can know if they are approved or denied
    Given the employee is on the employee page
    Then the employee should see the reimbursement information table

  Scenario: as a manager, I should be able to view pending reimbursements requests so I can make decisions about them
